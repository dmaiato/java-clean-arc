package br.com.gubee.interview.core.infrastructure.output.persistence.repository;

import br.com.gubee.interview.core.infrastructure.output.persistence.entity.PowerStatsEntity;
import br.com.gubee.interview.core.infrastructure.output.persistence.mapper.PowerStatsPersistenceMapper;
import br.com.gubee.interview.core.infrastructure.output.persistence.mapper.PowerStatsRowMapper;
...
public class PowerStatsRepositoryImpl implements PowerStatsRepository {
    ...
    public Optional<PowerStats> findById(UUID id) {
        ...
        List<PowerStatsEntity> powerStatsEntities = namedParameterJdbcTemplate
                .query(FIND_POWER_STATS_QUERY, params, new PowerStatsRowMapper());
